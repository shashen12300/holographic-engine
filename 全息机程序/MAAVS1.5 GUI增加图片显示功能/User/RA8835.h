...
#define DATA_PORT_IN   (DATA_PORT->CRH=0x88888888) 
#define DATA_PORT_OUT  (DATA_PORT->CRH=0x33333333)
//#define lcm_WriteByte  (DATA_PORT->ODR)
#define lcm_WriteByte(data)  DATA_PORT->ODR&=0x00FF,DATA_PORT->ODR|=(data<<8)&0xFF00
