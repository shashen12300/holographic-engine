...
void SPI_FLASH_Init(void)
{
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	RCC_APB2PeriphClockCmd(SPI_FLASH_SPI_SCK_GPIO_CLK, ENABLE);
...
void SPI_FLASH_CS_LOW(void)
{
	SPI_FLASH_SPI_SCK_1();
	SPI_Flash_Delay();
	GPIO_ResetBits(SPI_FLASH_CS_GPIO_PORT, SPI_FLASH_CS_PIN);
	SPI_Flash_Delay();
}
