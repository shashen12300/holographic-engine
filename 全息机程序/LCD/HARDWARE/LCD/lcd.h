...
#define LCD_RST_0  GPIOC->BRR = GPIO_Pin_8
#define LCD_RST_1  GPIOC->BSRR = GPIO_Pin_8

#define lcm_wr   	PBout(13)
#define lcm_rd  	PBout(14)
#define lcm_cs   	PBout(15)
#define lcm_a0   	PBout(12)
#define lcm_rst  	PCout(8)
...
#define lcm_WriteByte GPIOC->ODR
/*--------------------------------------------------------------*/
//???????????
